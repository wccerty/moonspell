...
Current milestone: core .aff/.dic parsing, exact lookup, PFX/SFX checking, cross product, compound rules, dictionary word pairs, REP/MAP/PHONE/`ph:` suggestions, and NGRAM-ranked candidates. The compatibility target is **Hunspell v1.7.3**, but full compatibility is not claimed until the complete upstream conformance suite passes.
